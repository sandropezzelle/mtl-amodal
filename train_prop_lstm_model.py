...
from utils import MyModelCheckpoint, stop_logger, start_logger
...
if __name__ == "__main__":
    ...
    logging_filename = "best_models/train_prop_lstm_model.log"
    ...
    model = prop_lstm_model.PropLSTMModel(embedding_matrix, token2id).build()
