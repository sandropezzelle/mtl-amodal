...
if __name__ == '__main__':
    ...
    weights = "best_quant_lstm_model/best-weight-model.hdf5"
    ...
    model = quant_lstm_model.QuantLSTMModel(embeddings, token2id).build()
    ...
    best_model = quant_lstm_model.QuantLSTMModel(embeddings, token2id).build()
    best_model.load_weights(weights)
    print(best_model.evaluate(dataset_t, t_q_out, batch_size=batch_size))
